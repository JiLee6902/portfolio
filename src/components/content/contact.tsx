            ...
            <div className="arlo_tm_section" id="contact">
                ...
                <div className="arlo_tm_footer_contact_wrapper_all">
                        ...
                        <div className="container">
                            <div className="leftbox">
                                ...
                                <div className="short_info_wrap">
                                    <ul>
                                        <li><p><label>Address:</label><span>Can Tho City, Viet Nam</span></p></li>
                                        <li><p><label>Email:</label><span><a href="mailto:example@gmail.com">jlq6902@gmail.com</a></span></p></li>
                                        <li><p><label>Phone:</label><span>+84 34 9659855</span></p></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="arlo_tm_footer_wrap">
                        <div className="container">
                            <p>&copy;JLQ . All Rights are Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
